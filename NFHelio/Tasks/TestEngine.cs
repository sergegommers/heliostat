namespace NFHelio.Tasks
{
  ...
  /// Tests the engines
  /// </summary>
  internal class TestEngine : ITask
  {
    /// <inheritdoc />
    string ITask.Command => "testengine";

    /// <inheritdoc />
    string ITask.Description => "testengine: tests engines";
    ...
    public void Execute(string[] args)
    {
      ...
      Program.context.BluetoothSpp.SendString($"Done testing pwm\n");
    }
